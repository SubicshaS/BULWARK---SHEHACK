...
<%
    ...
    final String from = "arunnsmvec@gmail.com";
    final String pass = "Abcd@123";
...
<div id="container">
  ...
  <center><center>  <h3 style="color: #ff0033"><img src="images/a.gif" width="100" height="60" alt="a"/>
              DSA code is send to your Email ID!! Check It !!!</h3></center>  <%
          ...
          Enter Fund Transfer Pin: <input type="text" name="otp" required style="border-radius:20px">
          </h3>
