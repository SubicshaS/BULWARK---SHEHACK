...
System.out.println("Key 1 pin2 :"+keys1);
...
int l10=(int) (Math.random() * 11);
 ...
 {
     if(kk[0].toString().equalsIgnoreCase(keyvalue[h].toString()))
     {
         if(kk[0].
                 toString().equalsIgnoreCase("0"))
         {
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
       ...
       else  if(kk[0].toString().equalsIgnoreCase("1"))
         {
             l1=1;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
          ...
          if(kk[0].toString().equalsIgnoreCase("2"))
         {
             l2=2;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
           ...
           if(kk[0].toString().equalsIgnoreCase("3"))
         {
             l3=3;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
            ...
            if(kk[0].toString().equalsIgnoreCase("4"))
         {
             l4=4;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
            ...
            if(kk[0].toString().equalsIgnoreCase("5"))
         {
             l5=5;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
             ...
             if(kk[0].toString().equalsIgnoreCase("6"))
         {
             l6=6;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
             ...
             else if(keyvalue[lo].toString().equalsIgnoreCase("9"))
             {
              ...
              if(kk[0].toString().equalsIgnoreCase("7"))
         {
             l7=7;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
             ...
             else if(keyvalue[lo].toString().equalsIgnoreCase("9"))
             {
               ...
               if(kk[0].toString().equalsIgnoreCase("8"))
         {
             l8=8;
             ...
             {  if(!kk[0].toString().equalsIgnoreCase(keyvalue[lo].toString()))
         {
             ...
             else if(keyvalue[lo].toString().equalsIgnoreCase("9"))
             {
                ...
                if(kk[0].toString().equalsIgnoreCase("9"))
         {
             l9=9;
...
System.out.println(pink);
  System.out.println(ask);
                ...
                <div class="calculator">
                    ...
                    <div class="row">
                        <a href="pin3.jsp?keys=<%=yellow%>"> <div class="key yellow" > </div> </a>
                        <a href="pin3.jsp?keys=<%=blue%>"> <div class="key blue"></div> </a>
                        <a href="pin3.jsp?keys=<%=pink%>">   <div class="key white"></div> </a>
                        <a href="pin3.jsp?keys=<%=ask%>">  <div class="key ask"></div> </a>
