...
System.out.println(keys1);
  ...
  <div class="row">
    ...
    <div class="key action"><-</div>
             ...
             <div class="row">
                 <a href="pin6.jsp?keys=<%=yellow%>"> <div class="key yellow" > </div> </a>
   <a href="pin6.jsp?keys=<%=blue%>"> <div class="key blue"></div> </a>
   <a href="pin6.jsp?keys=<%=pink%>">   <div class="key white"></div> </a>
   <a href="pin6.jsp?keys=<%=ask%>">  <div class="key ask"></div> </a>
